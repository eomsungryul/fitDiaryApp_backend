...
import static com.dwebss.fitdiary.backend.core.ProjectConstant.*;
...
public class CodeGenerator {
    ...
    private static final String TEMPLATE_FILE_PATH = PROJECT_PATH + "/src/test/resources/generator/template";//템플릿 위치
...
//    	genCode("exercise_course_set_info");
    ...
    public static void genModelAndMapper(String tableName, String modelName) {
        ...
        System.out.println(modelName + "성공적으로 생성 된 .java");
